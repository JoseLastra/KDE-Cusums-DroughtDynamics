...
This folder contains scripts to conduct the cumulative drought assessment and event detection described in Lastra et al., 2026. The scripts are in order and correspond to Event detection froom Cusums for both, time-series and raster data.
